...
{
public:
	MainFrame(wxFrame *parent,wxWindowID id = wxID_ANY,const wxString& title = "ToolBar",const wxPoint& pos = wxDefaultPosition,const wxSize& size = wxDefaultSize,long style = wxDEFAULT_FRAME_STYLE | wxCLIP_CHILDREN);
	virtual ~MainFrame();
